...
*
*
function mail_password($toemail, $name, $password){
//通用邮件发送类

$mail = new sdkSendEmail();

$html = $name.' 你好！<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;你在通讯录系统 <a href="http://contacts.logbt.net">contacts.logbt.net</a>中的登陆信息是：
<p>用户名是你的姓名的全拼;<br>密码是'.$password.'</p>
<br><br><br>
以上用户信息你还可以登陆公司其他内部系统：<br>
&nbsp;&nbsp;&nbsp;&nbsp;如果是开发人员或在参与某个项目，你可以登陆任务管理平台<a href="http://mantis.logbt.net">mantis.logbt.net</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;如果是开发人员需要提交项目到线，你可以登陆代码部署系统<a href="http://commity.logbt.net">commity.logbt.net</a>
