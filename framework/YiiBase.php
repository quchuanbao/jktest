...
class YiiBase
{
	...
	public static function autoload($className)
	{
		...
		$common_path =  PM_PATH_ROOT."/models/common/".$className.".php";
		$tools_path =  PM_PATH_ROOT."/tools/".$className.".php";
		$namespace_path = PM_PATH_ROOT."/models/".PM_NAME."/".$className.".php";
