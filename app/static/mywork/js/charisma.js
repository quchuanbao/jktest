$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', '/static/mywork/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', '/static/mywork/css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('#file_upload').uploadify({
        'swf': '/static/mywork/misc/uploadify.swf',
        'uploader': '/static/mywork/misc/uploadify.php'
