...
class UserForm extends CFormModel
{
	...
	{
		return array(
				array('realName,sex,memberShipId',
					'required',
					'message'=>'不能为空',
					 'on' => 'add'
					),
				array('memberShipId,tel,email,born,address,ismarry,ischild,sourceId,wxnum,cardNum,vipNum,realName,sex,startDate,endDate',
						'safe',
				),
				//array('img', 'checkPic', 'on' => 'add'),
				array(
						'img',
						'file',    //定义为file类型
						'allowEmpty'=>true,
