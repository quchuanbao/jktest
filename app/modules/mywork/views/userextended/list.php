<script>
	function del(id){
		$('#myModal').modal('show');
		$("#confirmUrl").attr("href",'/mywork/userextended/del/id/'+id);
	}
</script>
...
<!-- content starts -->
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="/mywork/userextended/">会员扩展表</a></li>
		</ul>
	</div>
<div class="row">
    ...
    <div class="row">
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-list"></i>  会员扩展表</h2>
					<div class="box-icon">
						<a href="/mywork/userextended/" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-refresh"></i></a>
						<a href="/mywork/userextended/add" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-plus-sign"></i></a>
					</div>
				</div>
				<div class="box-content">
				...
				<thead>
				<tr>
				<th>自增Id</th><th>会员ID</th>					<th>操作</th>
				</tr>
				</thead>
				<tbody>
				<?php 	
					foreach( $info as $n => $v){
						echo '
							...
							<td class="center" style="text-align:center;">
								<a  href="/mywork/userextended/modify/id/'.$v['id'].'">
