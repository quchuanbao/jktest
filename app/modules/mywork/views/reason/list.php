...
<!-- content starts -->
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="/mywork/reason/">参加原因管理</a></li>
		</ul>
	</div>
<div class="row">
                ...
                <div class="box-content">
                	<?php $form = $this->beginWidget('CActiveForm'); ?>					<ul class="thumbnails" style="padding-left:0px;">
							...
							<?php echo $form->textField($model,'id',array('value'=>$model->id,'class'=>'form-control','placeholder'=>'ID')); ?>						</li>
												<li style="margin-bottom:5px;">
							<?php echo $form->textField($model,'name',array('value'=>$model->name,'class'=>'form-control','placeholder'=>'参加原因')); ?>						</li>
    ...
    <div class="row">
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-list"></i>   参加原因列表</h2>
					<div class="box-icon">
						<a href="/mywork/reason/" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-refresh"></i></a>
						<a href="/mywork/reason/add" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-plus-sign"></i></a>
					</div>
				</div>
				<div class="box-content">
				...
				<thead>
				<tr>
				<th>ID</th><th>参加原因名称</th>					<th>操作</th>
				</tr>
				</thead>
				<tbody>
				<?php 	
