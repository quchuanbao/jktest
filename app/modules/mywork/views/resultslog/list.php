<script>
	function del(id){
		$('#myModal').modal('show');
		$("#confirmUrl").attr("href",'/mywork/resultslog/del/id/'+id);
	}
</script>
...
<div class="row">
    ...
    <div class="row">
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-list"></i>  业绩表</h2>
					<div class="box-icon">
						<a href="/mywork/resultslog/" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-refresh"></i></a>
						<a href="/mywork/resultslog/add" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-plus-sign"></i></a>
					</div>
				</div>
				<div class="box-content">
					...
					foreach( $info as $n => $v){
						echo '
							...
							<td class="center" style="text-align:center;">
								<a  href="/mywork/resultslog/modify/id/'.$v['id'].'">
