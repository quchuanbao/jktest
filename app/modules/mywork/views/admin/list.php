<script>
	function del(id){
		$('#myModal').modal('show');
		$("#confirmUrl").attr("href",'/mywork/admin/del/id/'+id);
	}
</script>
...
<div class="row">
    ...
    <div class="row">
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-list"></i>  管理员</h2>
					<div class="box-icon">
						<a href="/mywork/admin/" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-refresh"></i></a>
						<a href="/mywork/admin/add" class="btn  btn-round btn-default"><i class="glyphicon glyphicon-plus-sign"></i></a>
					</div>
				</div>
				<div class="box-content">
				...
				<thead>
				<tr>
				<th>ID</th><th>登录名</th><th>真实姓名</th><th>状态</th>					<th>操作</th>
				</tr>
				</thead>
				<tbody>
				<?php 	
					foreach( $info as $n => $v){
						...
						if ($v['status'] == 1) {
							...
							$status = '<span class="label">冻结</span>';
						}
						echo '
							<tr>
							<td>'.$v['id'].'</td>
							...
							<td class="center" style="text-align:center;">
								<a  href="/mywork/admin/modify/id/'.$v['id'].'">
