		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-edit"></i> 添加部门业绩表</h2>
					<div class="box-icon">
				...
				<?php $form = $this->beginWidget('CActiveForm');?>				<div class="box-content">
							...
							<?php echo $form->textField($model,'departmentId',array('value'=>$model->departmentId,'class'=>'form-control','placeholder'=>'用户ID'));?>							<?php echo $form->error($model,'departmentId'); ?>						</div>
												<div class="form-group">
